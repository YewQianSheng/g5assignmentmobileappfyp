...
public class proposalPdf extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(proposalPdf.this, LoginActivity.class));
        ...
        navHome2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(proposalPdf.this, student.class));
            }
        });
        ...
        navMark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(proposalPdf.this, Viewmark.class));
            }
        });
        ...
        navWork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(proposalPdf.this, WorkActivity.class));
            }
        });
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("proposalPdf");
    ...
    private void selectFiles() {
        ...
        if(title.isEmpty()){
            Toast.makeText(proposalPdf.this, "Please enter your filename.", Toast.LENGTH_SHORT).show();
        }
        else{
    ...
    private void UploadFiles(Uri data) {
        ...
        StorageReference reference = storageReference.child("proposalPdf/" + System.currentTimeMillis());
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(proposalPdf.this, "File Uploaded", Toast.LENGTH_SHORT).show();
