...
public class PPT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(PPT.this, LoginActivity.class));
        ...
        navHome2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PPT.this, student.class));
            }
        });
        ...
        navMark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PPT.this, Viewmark.class));
            }
        });
        ...
        navWork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(PPT.this, WorkActivity.class));
            }
        });
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("ppt");
    ...
    private void selectFiles() {
        ...
        if(title.isEmpty()){
            Toast.makeText(PPT.this, "Please enter your filename.", Toast.LENGTH_SHORT).show();
        }
        else{
    ...
    private void UploadFiles(Uri data) {
        ...
        StorageReference reference = storageReference.child("ppt/" + System.currentTimeMillis());
        reference.putFile(data)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(PPT.this, "File Uploaded", Toast.LENGTH_SHORT).show();
